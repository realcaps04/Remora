...
export function BottomSheet({
  ...
  return (
    <div className="absolute inset-0 z-40">
      ...
      <div className="absolute inset-x-0 bottom-0 rounded-t-[28px] bg-[#111113] px-5 pb-[max(20px,env(safe-area-inset-bottom))] pt-3 shadow-[0_-20px_60px_rgba(0,0,0,0.5)]">
